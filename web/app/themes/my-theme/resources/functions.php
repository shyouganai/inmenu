...
{
    register_taxonomy("category", ["place"], [
        "label" => "",
        "labels" => [
            "name" => "Категория",
        ],
...
add_action("init", "create_kitchen_taxonomy");
function create_kitchen_taxonomy()
{
    register_taxonomy("kitchen", ["place"], [
        "label" => "",
        "labels" => [
            "name" => "Кухня",
        ],
